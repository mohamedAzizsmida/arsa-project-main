 ...
 */
final class Version20250302224141 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE categorie_produit (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, typeentreprise VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE commande (id_commande INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, date_commande DATE DEFAULT NULL, status INT DEFAULT 0 NOT NULL, INDEX IDX_6EEAA67DA76ED395 (user_id), PRIMARY KEY(id_commande)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE commentaire (id INT AUTO_INCREMENT NOT NULL, post_id INT DEFAULT NULL, contenu VARCHAR(55) NOT NULL, id_user INT DEFAULT NULL, INDEX IDX_67F068BC4B89032C (post_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE formation (id INT AUTO_INCREMENT NOT NULL, association_id INT NOT NULL, titre VARCHAR(255) DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, formateur VARCHAR(255) DEFAULT NULL, date_debut DATETIME DEFAULT NULL, INDEX IDX_404021BFEFB9C8A5 (association_id), INDEX idx_formation_id (id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE post (id INT AUTO_INCREMENT NOT NULL, contenu VARCHAR(55) NOT NULL, date_publication DATE NOT NULL, id_user INT DEFAULT NULL, image VARCHAR(55) DEFAULT NULL, views INT DEFAULT NULL, likes INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, tel INT DEFAULT NULL, adress VARCHAR(255) DEFAULT NULL, role VARCHAR(30) DEFAULT NULL, roles JSON DEFAULT NULL COMMENT \'(DC2Type:json)\', UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), INDEX idx_user_id (id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user_formation (idFormation INT NOT NULL, idUser INT NOT NULL, INDEX IDX_40A0AC5BBCAA0AE9 (idFormation), INDEX IDX_40A0AC5BFE6E88D7 (idUser), PRIMARY KEY(idFormation, idUser)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE cour ADD CONSTRAINT FK_A71F964FC80C5868 FOREIGN KEY (id_formation_FK) REFERENCES formation (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE user_formation ADD CONSTRAINT FK_40A0AC5BBCAA0AE9 FOREIGN KEY (idFormation) REFERENCES user (id)');
        $this->addSql('ALTER TABLE user_formation ADD CONSTRAINT FK_40A0AC5BFE6E88D7 FOREIGN KEY (idUser) REFERENCES formation (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user_formation DROP FOREIGN KEY FK_40A0AC5BBCAA0AE9');
        $this->addSql('ALTER TABLE user_formation DROP FOREIGN KEY FK_40A0AC5BFE6E88D7');
